...
export function AboutMePage() {
    return (
        <div>
            <h1>ABOUT ME!</h1>
            <p>My name is Vincent and I am a software developer. I didn&apos;t always start out as one though!</p>
            <p>I originally had grand hopes of a career in law, but some self-discovery revealed that it was not a path I wanted to take.</p>
